        ...
        return(
            <header className="header main-column">
                ...
                <div className="footer-wrapper w-clearfix">
                    <a className="footer-nav-link w-inline-block" href="/"><img src="http://uploads.webflow.com/52f2c8085d8eed2b6b000300/52f3149a593f6edf410006e0_home-icon.svg" alt="" /></a>
